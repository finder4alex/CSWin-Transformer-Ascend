...
def parse_arguments():
    ...
    parser.add_argument("-a", "--arch", metavar="ARCH", default="cswin_64_24322_small_224",
    ...
    parser.add_argument('--multi_data_url', default="", help='path to multi dataset')
    ...
    parser.add_argument("--tail_length", default=10, type=int, help="Number of tail down iterations")
    parser.add_argument("--tail_lr", default=1e-5, type=float, help="tail down learning rate")
